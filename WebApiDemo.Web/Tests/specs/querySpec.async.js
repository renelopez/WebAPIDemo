...
describe('When verifying the Jasmine Test Environment', function () {
   ...
   //Spec - 1
    it('it should run a true test', function () {
...
describe("When querying the Breeze Web API", function() {
    ...
    it('should get at least one book(2)', function (done) {
    ...
    it('should get an order with its details', function(done) {
    ...
    it('should find the book with id 2', function(done) {
